...
it('provides access to all managers via the facade', function () {
    expect(Trustbird::people())->toBeInstanceOf(PeopleManager::class)
        ...
        ->and(Trustbird::ai())->toBeInstanceOf(AiManager::class)
        ...
        ->and(Trustbird::frameworks())->toBeInstanceOf(FrameworksManager::class)
        ...
        ->and(Trustbird::interviews())->toBeInstanceOf(InterviewsManager::class)
