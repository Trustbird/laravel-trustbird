...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('control_relations', function (Blueprint $table): void {
            $table->ulid('id')->primary();

            $table->foreignUlid('workspace_id')->after('id')->nullable()->constrained('workspaces')->cascadeOnDelete();

            $table->foreignUlid('control_id')
            ...
            $table->unique(['control_id', 'related_type', 'related_id'], 'control_relations_unique');
    ...
    {
        Schema::dropIfExists('control_relations');
